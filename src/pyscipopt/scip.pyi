...
class Model:
    ...
    def addMatrixVar(
        ...
        obj: float | np.ndarray = 0.0,
        pricedVar: bool | np.ndarray = False,
        pricedVarScore: float | np.ndarray = 1.0,
    ) -> MatrixVariable: ...
    ...
    def getParam(self, name: str) -> bool | int | float | str: ...
    def getParams(self) -> dict[str, bool | int | float | str]: ...
    ...
    def getRowParallelism(
        self, row1: Row, row2: Row, orthofunc: Literal[100, 101] = 101
    ) -> float: ...
    ...
    @overload
    def getSolVal(self, sol: Solution | None, expr: Union[Expr, GenExpr]) -> float: ...
    @overload
    def getSolVal(self, sol: Solution | None, expr: MatrixExpr) -> np.ndarray: ...
    ...
    def getWeightsKnapsack(self, cons: Constraint) -> dict[str, int]: ...
